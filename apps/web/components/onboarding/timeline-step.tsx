...
export function TimelineStep({ data, onUpdate, onSubmit, onBack, isSubmitting }: TimelineStepProps) {
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={onSubmit}
          disabled={isSubmitting}
          className="flex-1 rounded-xl bg-wedding-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-wedding-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wedding-600 disabled:cursor-not-allowed disabled:opacity-50"
        >
