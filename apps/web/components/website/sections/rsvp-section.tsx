      ...
      <div className="mx-auto max-w-2xl px-4">
          ...
          >
            ...
            <div className="flex gap-3">
              <input
                ...
                required
                className="border-border bg-background flex-1 rounded-lg border px-4 py-3 text-sm focus:outline-none focus:ring-2"
        ...
        {state === 'loading' && (
          <div className="flex flex-col items-center py-12">
            <div
              className="border-border h-8 w-8 animate-spin rounded-full border-4"
              style={{ borderTopColor: colors.primary }}
            />
            <p className="text-muted-foreground mt-4 text-sm">Looking you up...</p>
          </div>
        )}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
            ...
            {multipleGuests.map((guest) => (
              <button
                ...
                className="border-border bg-background w-full rounded-lg border p-4 text-left transition-shadow hover:shadow-md"
              >
                <span
        ...
        {state === 'expired' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
            <p className={`${bodyClass}`} style={{ ...bodyFont, color: `${colors.primary}BB` }}>
