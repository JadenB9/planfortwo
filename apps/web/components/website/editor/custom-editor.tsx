...
export function CustomEditor({ content, onChange }: CustomEditorProps) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label htmlFor="custom-html" className="text-sm font-medium text-foreground">
          HTML Content
        </label>
        <textarea
          id="custom-html"
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<b>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<i>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<a>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<p>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<br>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<ul>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<ol>'}</code>,{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<li>'}</code>, and{' '}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<h1>'}</code>
          {'-'}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">{'<h6>'}</code> are supported.
        </p>
      </div>
    </div>
  )
