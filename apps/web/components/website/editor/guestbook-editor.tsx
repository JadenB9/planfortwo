...
export function GuestbookEditor({ content, onChange }: GuestbookEditorProps) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label htmlFor="guestbook-message" className="text-sm font-medium text-foreground">
          Welcome Message
        </label>
        <textarea
      ...
      <div className="border-t border-border pt-4">
        <label className="flex items-center gap-3">
          ...
          />
          <span className="text-sm text-foreground">Require approval before entries are visible</span>
        </label>
