...
export const templates: TemplateMetadata[] = [
  {
    ...
    defaultColors: { primary: '#8B7355', secondary: '#D4C5B2', accent: '#C9A96E', background: '#FDF8F4' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#1A1A1A', secondary: '#F5F5F5', accent: '#C9A96E', background: '#FFFFFF' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#5C4033', secondary: '#E8DDD3', accent: '#8B6F47', background: '#FAF5EF' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#B76E79', secondary: '#F5E6E8', accent: '#D4A574', background: '#FFF5F5' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#333333', secondary: '#E8E8E8', accent: '#666666', background: '#FFFFFF' },
    fontPair: 'josefin-open-sans',
    tags: ['simple', 'clean'],
  },
  {
    ...
    defaultColors: { primary: '#C2674A', secondary: '#E4EBE4', accent: '#D07D56', background: '#FDF8F6' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#456349', secondary: '#E4EBE4', accent: '#7A9A7D', background: '#F4F7F4' },
  ...
  },
  {
    ...
    defaultColors: { primary: '#2B6B8A', secondary: '#E8F0F2', accent: '#D4A574', background: '#F8FCFD' },
    fontPair: 'dancing-script-nunito',
  ...
  },
  {
    ...
    defaultColors: { primary: '#2C2C2C', secondary: '#F0E6D3', accent: '#C9A96E', background: '#FDFBF7' },
    fontPair: 'playfair-lato',
    tags: ['luxury', 'formal'],
  },
  {
    ...
    defaultColors: { primary: '#6B5B95', secondary: '#F0E6F6', accent: '#FF6F61', background: '#FFF9FB' },
    fontPair: 'dancing-script-nunito',
    tags: ['playful', 'fun'],
  },
]
