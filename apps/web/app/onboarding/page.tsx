...
export default function OnboardingPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const onboardingData: OnboardingData = {
        yourFirstName: parsed.yourFirstName ?? null,
        yourLastName: parsed.yourLastName ?? null,
        partnerFirstName: parsed.partnerFirstName ?? null,
        partnerLastName: parsed.partnerLastName ?? null,
        partnerEmail: parsed.partnerEmail ?? null,
  ...
  return (
    <>
      ...
      {step === 0 && <NamesStep data={data} onUpdate={updateData} onNext={handleNext} />}
      {step === 1 && (
