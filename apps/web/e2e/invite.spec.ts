...
test.describe('Partner Invite Page', () => {
  test('invite page renders for unauthenticated user with sign-up option', async ({ page }) => {
    ...
    await expect(page.getByText(/someone special wants to plan their wedding/i)).toBeVisible()
